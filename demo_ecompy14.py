...
- la création et l'évaluation de différents modèles de Machine Learning : 
    ...
    st.write(
        """
Le principal challenge de ce projet fut la partie feature engineering à partir du seul tableau exploitable (events) dont nous comprenions les données.
Cette table, ne contenant que 5 colonnes, nous a tout de même permis de créer une dizaine de variables pour observer une partie des comportements des utilisateurs, essayer de les catégoriser et tenter des premières prédictions sur leur passage à l'achat.
    """)
